    ...
    for (FortifyRule rule : rules) {
      ...
      if ("1".equals(key) && "3.3".equals(rule.getFormatVersion().toString())) {
        ...
        assertRule(
          ...
          "java",
          "CRITICAL",
          "<h2>ABSTRACT</h2><p>Dummy abstract</p><h2>EXPLANATION</h2><p>Dummy explanation</p><h2>RECOMMENDATIONS</h2><p>Dummy recommendations</p><h2>TIPS</h2><p><ul><li>Dummy tip 1</li><li>Dummy tip 2</li></ul></p><h2>REFERENCES</h2><p>\\[1\\] Dummy reference . - Dummy author .</p><p>\\[2\\] Dummy reference . - Dummy author .</p>");
